...
namespace DeExtinctionMod.Prefabs.Creatures
{
    public class GrandGliderPrefab : CreatureAsset
    {
        ...
        public override ScannableCreatureData ScannableSettings => new ScannableCreatureData(true, 4f, "Lifeforms/Fauna/LargeHerbivores", new string[] { "Lifeforms", "Fauna", "LargeHerbivores" }, QPatch.assetBundle.LoadAsset<Sprite>("GrandGlider_Popup"), QPatch.assetBundle.LoadAsset<Texture2D>("GrandGlider_Ency"));
        ...
        public override SwimInSchoolData SwimInSchoolSettings => new SwimInSchoolData(0.8f, kMyVelocity * 1.4f, 1.5f, 2f, 30f, 1f, 0f);
