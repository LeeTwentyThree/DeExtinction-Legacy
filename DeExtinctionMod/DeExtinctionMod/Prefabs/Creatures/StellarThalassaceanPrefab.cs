...
namespace DeExtinctionMod.Prefabs.Creatures
{
    public class StellarThalassaceanPrefab : ThalassaceanPrefab
    {
        ...
        public override ScannableItemData ScannableSettings => new ScannableItemData(true, 8f, "Lifeforms/Fauna/Carnivores", new string[] { "Lifeforms", "Fauna", "Carnivores" }, QPatch.assetBundle.LoadAsset<Sprite>("Stellar_Popup"), QPatch.assetBundle.LoadAsset<Texture2D>("Stellar_Ency"));
